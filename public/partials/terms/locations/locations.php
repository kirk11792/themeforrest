<?php
	...
	}elseif ($instance->location_style == 'advanced'){
		directorypress_display_template('partials/terms/locations/parts/location-style-advanced.php', array('instance' => $instance, 'terms' => $terms));
